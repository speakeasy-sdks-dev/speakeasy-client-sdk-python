...
from speakeasy_client_sdk_python.models import operations
...
class Reports(BaseSDK):
    ...
    def get_changes_report_signed_url(
        ...
        request = cast(operations.GetChangesReportSignedURLRequest, request)
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.GetChangesReportSignedURLResponse(signed_access=utils.unmarshal_json(http_res.text, Optional[operations.GetChangesReportSignedURLSignedAccess]), status_code=http_res.status_code, content_type=http_res.headers.get("Content-Type") or "", raw_response=http_res)
    ...
    def get_linting_report_signed_url(
        ...
        request = cast(operations.GetLintingReportSignedURLRequest, request)
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.GetLintingReportSignedURLResponse(signed_access=utils.unmarshal_json(http_res.text, Optional[operations.GetLintingReportSignedURLSignedAccess]), status_code=http_res.status_code, content_type=http_res.headers.get("Content-Type") or "", raw_response=http_res)
        if utils.match_response(http_res, ["4XX","5XX"], "*"):
            raise SDKError("API error occurred", http_res.status_code, http_res.text, http_res)
    ...
    def upload_report(
        ...
        request = cast(operations.UploadReportRequestBody, request)
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.UploadReportResponse(uploaded_report=utils.unmarshal_json(http_res.text, Optional[operations.UploadReportUploadedReport]), status_code=http_res.status_code, content_type=http_res.headers.get("Content-Type") or "", raw_response=http_res)
        if utils.match_response(http_res, ["4XX","5XX"], "*"):
            raise SDKError("API error occurred", http_res.status_code, http_res.text, http_res)
