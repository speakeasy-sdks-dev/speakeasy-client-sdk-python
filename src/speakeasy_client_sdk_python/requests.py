    ...
    def generate_request_postman_collection(
        ...
        *,
        request: Union[
            ...
            operations.GenerateRequestPostmanCollectionRequestTypedDict,
        ],
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="generateRequestPostmanCollection",
                oauth2_scopes=[],
    ...
    def get_request_from_event_log(
        ...
        *,
        request: Union[
            ...
            operations.GetRequestFromEventLogRequestTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="getRequestFromEventLog",
                oauth2_scopes=[],
                security_source=self.sdk_configuration.security,
            ),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.GetRequestFromEventLogResponse(
                unbounded_request=utils.unmarshal_json(
                    http_res.text, Optional[shared.UnboundedRequest]
                ),
                status_code=http_res.status_code,
                content_type=http_res.headers.get("Content-Type") or "",
                raw_response=http_res,
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.QueryEventLogResponse(
                bounded_requests=utils.unmarshal_json(
                    http_res.text, Optional[List[shared.BoundedRequest]]
                ),
                status_code=http_res.status_code,
                content_type=http_res.headers.get("Content-Type") or "",
                raw_response=http_res,
