...
class Suggest(BaseSDK):
    ...
    def apply_operation_i_ds(
        ...
        *,
        request: Union[
            operations.ApplyOperationIDsRequest,
            operations.ApplyOperationIDsRequestTypedDict,
        ],
        ...
        req = self.build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                ...
                True,
                "json",
                Optional[operations.ApplyOperationIDsRequestBody],
            ),
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="applyOperationIDs",
                oauth2_scopes=[],
    ...
    def suggest_operation_i_ds(
        ...
        *,
        request: Union[
            operations.SuggestOperationIDsRequest,
            operations.SuggestOperationIDsRequestTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        req = self.build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                ...
                False,
                "multipart",
                operations.SuggestOperationIDsRequestBody,
            ),
            timeout_ms=timeout_ms,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="suggestOperationIDs",
                oauth2_scopes=[],
                security_source=self.sdk_configuration.security,
            ),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.SuggestOperationIDsResponse(
                suggested_operation_i_ds=utils.unmarshal_json(
                    http_res.text, Optional[shared.SuggestedOperationIDs]
                ),
                status_code=http_res.status_code,
                content_type=http_res.headers.get("Content-Type") or "",
                raw_response=http_res,
    ...
    def suggest_operation_i_ds_registry(
        ...
        *,
        request: Union[
            operations.SuggestOperationIDsRegistryRequest,
            operations.SuggestOperationIDsRegistryRequestTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        req = self.build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.suggest_operation_i_ds_opts,
                False,
                True,
                "json",
                Optional[shared.SuggestOperationIDsOpts],
            ),
            timeout_ms=timeout_ms,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="suggestOperationIDsRegistry",
                oauth2_scopes=[],
                security_source=self.sdk_configuration.security,
            ),
            request=req,
